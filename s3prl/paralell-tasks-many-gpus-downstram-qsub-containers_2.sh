...
# qsub -v distilled_model_checkpoint="task_vector_dhubert_ls_960_weight_0.8_and_mert_ls_960_weight_0.2_both_init_hubert_both_same_seed_True_ties_weight_0.3",stage="train",current_row=95,logfile_row=95,checkpoint_method="hardcoded" paralell-tasks-many-gpus-downstram-qsub-containers.sh
