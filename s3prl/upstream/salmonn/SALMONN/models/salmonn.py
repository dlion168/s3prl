...
class SALMONN(nn.Module):
    ...
    def __init__(
        ...
        #### Do not load LLaMA model due to the heavy consumption for VRAM ####
        ...
        if self.use_speech_Qformer:
            ...
            self.speech_llama_proj = nn.Linear(
                self.speech_Qformer.config.hidden_size, llama_model_hidden_size
            )
    ...
    def from_config(cls, config):
        ...
        llama_model_hidden_size = config.get("llama_model_hidden_size", None)
        ...
        model = cls(
            ...
            llama_model_hidden_size=llama_model_hidden_size,
