...
def video_llama_local(encoder_ckpt, projector_ckpt, *args, **kwargs):
    """
...
def video_llama_url(encoder_ckpt, projector_ckpt, refresh=False, *args, **kwargs):
    """
    The model from URL
        ckpt (str): URL
    """
...
def video_llama(refresh=False, *args, **kwargs):
