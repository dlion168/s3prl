...
#-------------#
from ..model import *
from .dataset import LibriCountDataset, LibriCountFeatureDataset
...
class DownstreamExpert(nn.Module):
    ...
    def __init__(self, upstream_dim, downstream_expert, expdir, **kwargs):
        ...
        self.train_dataset = LibriCountFeatureDataset(root_dir, self.pre_extract_dir, train_folds, sample_rate = kwargs["sample_rate"]
            ) if self.pre_extract_dir else LibriCountDataset(root_dir, train_folds, sample_rate = kwargs["sample_rate"])
        self.valid_dataset = LibriCountFeatureDataset(root_dir, self.pre_extract_dir, [valid_fold], sample_rate = kwargs["sample_rate"]
            ) if self.pre_extract_dir else LibriCountDataset(root_dir, [valid_fold], sample_rate = kwargs["sample_rate"])
        self.test_dataset = LibriCountFeatureDataset(root_dir, self.pre_extract_dir, [test_fold], sample_rate = kwargs["sample_rate"]
            ) if self.pre_extract_dir else LibriCountDataset(root_dir, [test_fold], sample_rate = kwargs["sample_rate"])
