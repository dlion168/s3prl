...
from ..model import *
from .dataset import (
    collate_fn_padd, DataManager, WavExtractor, WavSet, get_norm_stat_for_wav
)
...
class DownstreamExpert(nn.Module):
    ...
    def __init__(self, upstream_dim, downstream_expert, expdir, ema_decay=0.999, confidence_threshold=0.0, **kwargs):
    ...
    def _initialize_teacher(self):
        ...
        for teacher_param, student_param in zip(self.teacher_model.parameters(), self.student_model.parameters()):
            ...
            teacher_param.requires_grad = False  # Freeze teacher weights
    ...
    def generate_pseudo_labels(self, features):
        """
        Generate pseudo-labels using the teacher model with Gaussian noise applied to its input.
        """
        with torch.no_grad():
