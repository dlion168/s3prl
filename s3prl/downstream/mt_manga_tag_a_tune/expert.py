...
class DownstreamExpert(nn.Module):
    ...
    def __init__(self, upstream_dim, downstream_expert, expdir, **kwargs):
        ...
        self.train_dataset = MTGMoodFeatureDataset(self.pre_extract_dir, self.datarc, 'train') if self.pre_extract_dir else MTGMoodAudioDataset(root_dir, self.datarc, 'train')
        self.dev_dataset = MTGMoodFeatureDataset(self.pre_extract_dir, self.datarc, 'dev') if self.pre_extract_dir else MTGMoodAudioDataset(root_dir, self.datarc, 'dev')
        self.test_dataset = MTGMoodFeatureDataset(self.pre_extract_dir, self.datarc, 'test') if self.pre_extract_dir else MTGMoodAudioDataset(root_dir, self.datarc, 'test')
