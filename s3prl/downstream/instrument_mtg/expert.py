...
#-------------#
from ..model import *
from .dataset import MTGInstrumentAudioDataset, MTGInstrumentFeatureDataset
...
class DownstreamExpert(nn.Module):
    ...
    def __init__(self, upstream_dim, downstream_expert, expdir, **kwargs):
        ...
        self.train_dataset = MTGInstrumentFeatureDataset(self.pre_extract_dir, self.datarc, 'train') if self.pre_extract_dir else MTGInstrumentAudioDataset(root_dir, self.datarc, 'train')
        self.dev_dataset = MTGInstrumentFeatureDataset(self.pre_extract_dir, self.datarc, 'dev') if self.pre_extract_dir else MTGInstrumentAudioDataset(root_dir, self.datarc, 'dev')
        self.test_dataset = MTGInstrumentFeatureDataset(self.pre_extract_dir, self.datarc, 'test') if self.pre_extract_dir else MTGInstrumentAudioDataset(root_dir, self.datarc, 'test')
