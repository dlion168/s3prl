...
# qsub -v distilled_model_checkpoint="task_vector_dhubert_ls_100_weight_0.8_and_mert_ls_960_weight_0.2_both_init_hubert_both_same_seed",stage="train",current_row=72,logfile_row=72,checkpoint_method="hardcoded" paralell-tasks-many-gpus-downstram-qsub-containers.sh
...
tasks=("aec_esc50")  # "vocalset_singer_id" "vocalset_technique_id"   "ks" "ic" "instrument_nsynth"  "pitch_nsynth"  "aec_esc50"
